...
ArrayList<Bean> al = new ViewDAO().userFileForDownload(uid); %>
				...
				<div class="row">
					...
					<h1 style="color: white; margin-top: 5%;"><b>Your Files</b></h1>        
				            ...
				            <table align="center" border="1" bordercolor="white" style="background-color: red;" >
              				...
              				<td style="color: white; font-family: Times New Roman; padding: 20px;"><a href="./DownloadFileServlet_user?uid=<%=uid%>&fid=<%=b.getFid()%>">Download File</a> </td>
              				</tr>
              				<%} %>
              				</table>
              				<%} %>
