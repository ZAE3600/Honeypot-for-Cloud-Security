...
<%ArrayList<Bean> al = new ViewDAO().routerViewFeedBack(); %>
<!-- Sidebar -->
		...
		<div class="col-md-12">			
			<form class="" role="form" action="LoginServlet" method="post">
				<div class="row">
					...
					%>	     
					<%if(al.isEmpty()){ %>
					<h1 style="color: white; margin-top: 5%;"><b>No FeedBack</b></h1>
					<%} %>  	
				    <%if(!al.isEmpty()){ %>
					<h1 style="color: white; margin-top: 5%;"><b>Feed Back</b></h1>        
				            <div class="templatemo-input-icon-container">
				            <table align="center" border="1" bordercolor="white" style="background-color: red;" >
              				<tr align="center">
              				<th style="color: white; font-family: Times New Roman; padding: 20px;">FeedBack ID</th>
