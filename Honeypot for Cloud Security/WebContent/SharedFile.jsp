...
ArrayList<Bean> al = new ViewDAO().userViewSharedFiles(mail); %>
				...
				<div class="row">
					...
					<h1 style="color: white; margin-top: 5%;"><b>Your Files</b></h1>        
				            ...
				            <table align="center" border="1" bordercolor="white" style="background-color: red;" >
              				...
              				<th style="color: white; font-family: Times New Roman; padding: 20px;">To Email</th>
              				...
              				<td style="color: white; font-family: Times New Roman; padding: 20px;"><%=b.getStatus()%></td>
              				</tr>
              				<%} %>
              				</table>
              				<%} %>
