...
<%ArrayList<Bean> al = new ViewDAO().routerViewFiles(); %>
<!-- Sidebar -->
		...
		<div class="col-md-12">			
			<form class="" role="form" action="LoginServlet" method="post">
				<div class="row">
					...
					<%} %>  	
				    <%if(!al.isEmpty()){ %>
					<h1 style="color: white; margin-top: 5%;"><b>Shared Files</b></h1>        
				            ...
				            <table align="center" border="1" bordercolor="white" style="background-color: red;" >
              				...
              				<th style="color: white; font-family: Times New Roman; padding: 20px;">UsedIpaddress</th>
              				</tr>
              				 <%for(Bean b:al){ %>
             				 <tr>
