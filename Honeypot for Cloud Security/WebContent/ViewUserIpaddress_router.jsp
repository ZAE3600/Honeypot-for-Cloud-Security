...
<%ArrayList<Bean> al = new ViewDAO().routerViewAcceptedUsers(); %>
<!-- Sidebar -->
		...
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-login-form-2" role="form" action="LoginServlet" method="post">
				<div class="row">
					...
					<%} %>  	
				    <%if(!al.isEmpty()){ %>
					<h1 style="color: white; margin-top: 5%;"><b>User Details with Ipaddress </b></h1>        
				            ...
				            <table align="center" border="1" bordercolor="white" style="background-color: red;" >
              				...
              				<th style="color: white; font-family: Times New Roman; padding: 20px;">IpAddress</th>
              				</tr>
              				 <%for(Bean b:al){ %>
             				 <tr>
