...
@WebServlet("/ReceivedFileServlet_user")
public class ReceivedFileServlet_user extends HttpServlet {
	...
	try {
	PreparedStatement ps = con.prepareStatement(" select honeypot,file from fileupload where fid=?");
	ps.setInt(1, fid);
